...
<style>
    ...
    .ride-input-group:last-child { border-bottom: none; }
    ...
    .dot-pickup { background: #2563EB; box-shadow: 0 0 10px rgba(37, 99, 235, 0.4); }
    .dot-dropoff { background: #F59E0B; box-shadow: 0 0 10px rgba(245, 158, 11, 0.4); }
...
<div class="modern-status-bar" id="rideStatusBar">
    <div class="row align-items-center">
        <div class="col-auto">
            <div class="rounded-circle bg-primary p-2" style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;">
...
<div class="command-center" id="ratingModal" style="display: none; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                    ...
                    response.data.forEach((opt, index) => {
                        ...
                        card.innerHTML = `
                            <div class="rounded-4 overflow-hidden shadow-lg mb-2" style="transform: rotate(2deg);">
                                <img src="${opt.id === 1 ? 'https://images.pexels.com/photos/3729464/pexels-photo-3729464.jpeg?auto=compress&cs=tinysrgb&w=300' : (opt.id === 2 ? 'https://images.pexels.com/photos/3853337/pexels-photo-3853337.jpeg?auto=compress&cs=tinysrgb&w=300' : 'https://images.pexels.com/photos/4553277/pexels-photo-4553277.jpeg?auto=compress&cs=tinysrgb&w=300')}" class="w-100" alt="ATLAS AND CO Fleet">
                            </div>
