    ...
    confirmBtn.onclick = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // On vérifie si la course est prévue pour un autre jour que le jour actuel
                let isLaterDay = false;
                ...
                if (isLaterDay) {
                    ...
                    const title = "Réservation enregistrée !";
                    const msg = `Votre course prévue le ${dateFormatted} a bien été enregistrée. Elle sera prise en compte et un chauffeur vous sera attribué.`;
