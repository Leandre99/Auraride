        ...
        <div class="container py-5">
            ...
            <div class="row g-4 pt-5">
                ...
                <div class="col-md-4 animate__animated animate__fadeInUp animate__delay-1s">
                    <div class="card border-0 shadow-sm rounded-4 p-4 h-100 bg-light">
                        <div class="kpi-icon bg-primary text-white mb-3 shadow-sm" style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; border-radius: 12px;"><i class="bi bi-leaf-fill fs-4"></i></div>
