...
@section('content')
    ...
    <section id="hero" class="py-5 position-relative overflow-hidden"
        style="background: linear-gradient(180deg, #FFFFFF 0%, var(--bg-light) 100%);">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <a href="{{ route('client.dashboard') }}"
                        class="btn btn-primary btn-lg px-5 py-3 mt-3 mb-5 d-inline-block fw-bold">Réserver une course →</a>


                    <div class="mt-5 d-flex align-items-center gap-4">
                        <div class="d-flex">
                            <img src="https://i.pravatar.cc/150?img=1" class="rounded-circle border border-2 border-white"
                                style="width: 40px; height: 40px; margin-right: -15px;" alt="">
                            <img src="https://i.pravatar.cc/150?img=2" class="rounded-circle border border-2 border-white"
                                style="width: 40px; height: 40px; margin-right: -15px;" alt="">
                            <img src="https://i.pravatar.cc/150?img=3" class="rounded-circle border border-2 border-white"
                                style="width: 40px; height: 40px;" alt="">
                        </div>
                        <div class="small text-muted">
                            Service disponible <span class="fw-bold text-dark">24h/24</span> — Chauffeurs certifiés &
                            assurés
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 mt-3">
                <div class="col-md-4">
                    <div class="p-5 glass-panel h-100 border-0 shadow-sm hover-translate-up transition">
                        <div class="rounded-3 bg-primary-subtle text-primary d-flex align-items-center justify-content-center mb-4"
                        ...
                        <p class="text-muted mb-0">Chauffeurs rigoureusement sélectionnés et suivi en temps réel de chaque
                            trajet 24/7.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-5 glass-panel h-100 border-0 shadow-sm hover-translate-up transition">
                        <div class="rounded-3 bg-primary-subtle text-primary d-flex align-items-center justify-content-center mb-4"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                ...
                                <path
                                    d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09zM4.157 8.5H7a.5.5 0 0 1 .478.647L6.11 13.59l5.733-6.09H9a.5.5 0 0 1-.478-.647L9.89 2.41 4.157 8.5z" />
                            </svg>
                        </div>
                        <h4>Rapidité d'intervention</h4>
                        <p class="text-muted mb-0">Notre algorithme avancé garantit qu'un chauffeur arrive chez vous en
                            quelques minutes.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-5 glass-panel h-100 border-0 shadow-sm hover-translate-up transition">
                        ...
                        <p class="text-muted mb-0">Seuls les meilleurs véhicules. Des berlines électriques aux SUVs de luxe.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="services" class="py-5 bg-light">
        <div class="container py-5">
            <div class="text-center mb-5">
                ...
                <h2 class="display-5 fw-bold">Solutions de Mobilité <span class="text-primary-gradient">Sur Mesure</span>
                </h2>
            </div>
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="glass-panel p-5 h-100 border-0 shadow-sm bg-white hover-up transition">
                        <div class="rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center mb-4"
                            style="width: 70px; height: 70px;">
                            <i class="bi bi-car-front fs-1"></i>
                        </div>
                        <h3 class="fw-bold mb-3">VTC Premium</h3>
                        <p class="text-muted mb-4">Commandez un chauffeur privé en quelques secondes. Voyagez dans des
                            véhicules de luxe avec un service irréprochable.</p>
                        <div class="small text-muted mb-3 p-3 rounded-3 bg-light"><strong>VTC / taxi premium</strong> : vous
                            êtes conduit par un chauffeur sur un trajet ponctuel (départ → arrivée).</div>
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i> Toujours <strong>avec
                                    chauffeur</strong></li>
                            <li class="mb-2"><i class="bi bi-check2-circle text-primary me-2"></i> Chauffeurs professionnels
                                &amp; véhicules haut de gamme</li>
                            <li><i class="bi bi-check2-circle text-primary me-2"></i> Disponibilité 24/7</li>
                        </ul>
                        <a href="{{ route('register') }}" class="btn btn-outline-premium w-100 py-3">Réserver une course
                            avec chauffeur</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="glass-panel p-5 h-100 border-0 shadow-sm bg-white hover-up transition">
                        <div class="rounded-circle bg-warning-subtle text-warning d-flex align-items-center justify-content-center mb-4"
                            style="width: 70px; height: 70px;">
                            <i class="bi bi-key fs-1"></i>
                        </div>
                        <h3 class="fw-bold mb-3">Location de véhicules</h3>
                        <div class="small text-muted mb-3 p-3 rounded-3 bg-light"><strong>Location</strong> : vous réservez
                            un véhicule pour une <strong>période</strong> (dates de début / fin). Vous pouvez choisir
                            <strong>avec ou sans chauffeur</strong>, selon offre.</div>
                        <p class="text-muted mb-4">Louez nos véhicules d’exception pour vos déplacements personnels ou pros
                            — ce n’est pas une course ponctuelle type taxi.</p>
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-check2-circle text-warning me-2"></i> Flotte de prestige</li>
                            <li class="mb-2"><i class="bi bi-check2-circle text-warning me-2"></i> Durée flexible
                                (jour/semaine)</li>
                            <li><i class="bi bi-check2-circle text-warning me-2"></i> Assurance premium incluse</li>
                        </ul>
                        <a href="{{ route('location') }}"
                            class="btn btn-outline-premium w-100 py-3 border-warning text-warning"
                            style="--primary: #F59E0B;">Louer un véhicule</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 text-center">
                ...
                <div class="col-md-4">
                    <div class="glass-panel p-5 h-100 border-0 shadow-sm hover-up transition position-relative bg-light">
                        <div class="position-absolute top-0 start-50 translate-middle badge rounded-circle bg-primary text-white d-flex align-items-center justify-content-center border border-4 border-light shadow-sm"
                            style="width: 40px; height: 40px; font-size: 1.2rem;">1</div>
                        <div class="rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center mx-auto mb-4 mt-2"
                            style="width: 80px; height: 80px;">
                            <i class="bi bi-envelope fs-1"></i>
                        </div>
                        <h4 class="fw-bold mb-3">Email</h4>
                        <p class="text-muted mb-0">Envoyez-nous un email à <a href="mailto:contact@atlasandco.fr"
                                class="text-decoration-none fw-bold">contact@atlasandco.fr</a> avec vos dates, le type de
                            véhicule souhaité et vos besoins.</p>
                    </div>
                </div>
                <!-- Step 2 -->
                <div class="col-md-4">
                    <div class="glass-panel p-5 h-100 border-0 shadow-sm hover-up transition position-relative bg-light">
                        <div class="position-absolute top-0 start-50 translate-middle badge rounded-circle bg-warning text-dark d-flex align-items-center justify-content-center border border-4 border-light shadow-sm"
                            style="width: 40px; height: 40px; font-size: 1.2rem;">2</div>
                        <div class="rounded-circle bg-warning-subtle text-warning d-flex align-items-center justify-content-center mx-auto mb-4 mt-2"
                            style="width: 80px; height: 80px;">
                            <i class="bi bi-telephone fs-1"></i>
                        </div>
                        <h4 class="fw-bold mb-3">Téléphone</h4>
                        <p class="text-muted mb-0">Appelez-nous au <a href="tel:0758279237"
                                class="text-decoration-none text-warning fw-bold">07 58 27 92 37</a>. Un agent vous répond
                            et confirme votre réservation en direct.</p>
                    </div>
                </div>
                <!-- Step 3 -->
                <div class="col-md-4">
                    <div class="glass-panel p-5 h-100 border-0 shadow-sm hover-up transition position-relative bg-light">
                        <div class="position-absolute top-0 start-50 translate-middle badge rounded-circle bg-primary text-white d-flex align-items-center justify-content-center border border-4 border-light shadow-sm"
                            style="width: 40px; height: 40px; font-size: 1.2rem;">3</div>
                        <div class="rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center mx-auto mb-4 mt-2"
                            style="width: 80px; height: 80px;">
                            <i class="bi bi-card-checklist fs-1"></i>
                        </div>
                        <h4 class="fw-bold mb-3">Formulaire en ligne</h4>
                        <p class="text-muted mb-0">Remplissez notre formulaire de location en ligne et recevez une
                            confirmation rapide.</p>
                    </div>
                </div>
            </div>
        </div>
